...
Ids
  ...
  - 0: Recibe la lista de salas desde el server. El primer byte del buffer es 1 si la petición fue exitosa y 0 en caso contrario. Luego, el buffer está ordenado en pares de bytes, donde el primeros 1 bytes son el id de la sala, y el segundo 1 bytes son la cantidad de jugadores en ella, luego se repite hasta completar el largo del buffer.
